...
<div id="tw">
    ...
    ?> 
    <div class="tw-wenzi" data-kui-anim="fadeInUp">
	<div class="main_img">
        <?php $random_image3 = rand(1, 10); ?>
            <img src="<?php echo TEMPLATE_URL; ?>images/weiyu/touxiang<?php echo $random_image3; ?>.jpg">
    </div>
    ...
    <?php endforeach;?>
	<li id="pagenavi" data-kui-anim="fadeInUp"><?php echo $pageurl;?></li>
    </div>
</div><!--end #tw-->
</div><!--end #contentleft-->
<?php
